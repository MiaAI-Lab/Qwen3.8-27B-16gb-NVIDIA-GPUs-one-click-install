...
<!--
     ...
     Examples that could fit this repo: another chat UI, a systemd unit,
     support for a different GPU family, a benchmark script, a new profile
     for a card size we have not measured, or a lint/validate step in CI.
